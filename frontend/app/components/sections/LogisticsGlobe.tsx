...
//   useEffect(() => {
//     const handleResize = () => setWidth(window.innerWidth > 1400 ? 800 : window.innerWidth - 40);
...
//   return (
//     // 🆕 SECTION BORDER: Added border-y and border-white/10 to frame the whole section
//     <section className="py-24 bg-[#0f1b2d] overflow-hidden relative border-y border-white/10 min-h-[800px] flex items-center">

//       {/* 🆕 IMAGE LAYER: Covers everything, but stays behind text */}
//       <div className="absolute inset-0 z-0 pointer-events-none">

//         {/* 🆕 GLASS GRADIENT: Instead of solid blue, we use semi-transparent blue so the image shows through */}
//         <div className="absolute inset-0 bg-gradient-to-r from-[#0f1b2d]/90 via-[#0f1b2d]/80 to-transparent z-10 backdrop-blur-[2px]" />

//         {/* Dynamic Image */}
//         <div
//           className={`absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ${!isTransitioning && activeHub ? 'opacity-60' : 'opacity-0'}`}
//           style={{
...
//             </h3>
//             {/* 🆕 TEXT SHADOW: Added drop-shadow to make text readable over images */}
...
//           {/* 🆕 GLASS CARDS: Added transparency to these boxes too */}
